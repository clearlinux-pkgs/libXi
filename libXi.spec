...
Version  : 1.7.5
Release  : 4
URL      : http://xorg.freedesktop.org/releases/individual/lib/libXi-1.7.5.tar.gz
Source0  : http://xorg.freedesktop.org/releases/individual/lib/libXi-1.7.5.tar.gz
